...
Without this the pilot produces opinions instead of data, and the offline decision in KMO-4.1 has nothing to revisit itself against.
...
- [ ] #4 Offline punches and sync outcomes are counted, so pilot connectivity can be assessed against the KMO-4.1 decision
