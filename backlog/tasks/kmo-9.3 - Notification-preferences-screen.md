...
Replaces the placeholder stubbed in KMO-5.1. Per-category toggles for punch reminders, leave decisions, documents to sign and mark corrections, persisted server-side and respected when sending.
